  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="../../../../resources/assets/img/gallery/logo-n.png" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link active" aria-current="page" href="web-development.html">Web Development</a></li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/design.png" alt="courses" />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/psychology.png" alt="courses" />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/philosophy.png" alt="courses" />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/photographs.png" alt="courses" />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/arguments.png" alt="courses" />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/experience-design.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">User Research for User Experience Design</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The Museum of Modern Art</a>
                </div>
              </div>
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/user-design.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">User Research for User Experience Design</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The Museum of Modern Art</a>
                </div>
              </div>
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/critical-thinking.png" alt="courses" />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/art-design.png" alt="courses" />
                <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/user-research.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Modern and Contemporary Art and Design</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The Museum of Modern Art</a>
                </div>
              </div>
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/ux.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Modern and Contemporary Art and Design</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The Museum of Modern Art</a>
                </div>
              </div>
            ...
            <div class="col-md-4 mb-4">
              <div class="card h-100"><img class="card-img-top w-100" src="../../../../resources/assets/img/gallery/art-design-1.png" alt="courses" />
                <div class="card-body">
                  <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Modern and Contemporary Art and Design</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The Museum of Modern Art</a>
                </div>
              </div>
      ...
      <section>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 col-lg-4 mb-5"><img src="../../../../resources/assets/img/gallery/cta.png" width="280" alt="cta" /></div>
      ...
      <section class="bg-secondary">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="../../../../resources/assets/img/gallery/footer-logo.png" height="51" alt="" /></a>
